    ...
    <div className="flex min-h-screen flex-col bg-[#FAFAFA] lg:grid lg:h-screen lg:min-h-0 lg:grid-rows-[56px_1fr_96px]">
      <header className="flex items-center justify-between gap-2 border-b border-zinc-200/80 bg-white px-3 py-2 lg:px-6 lg:py-0">
        ...
        >
          ...
          >
            <Droplet className="h-3 w-3" strokeWidth={1.8} />
          ...
          <div
            aria-label="User"
            className="hidden h-7 w-7 items-center justify-center rounded-full bg-zinc-900 font-mono text-[10px] uppercase tracking-wider text-white sm:flex"
          >
            NP
          </div>
        </motion.div>
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-3 p-3 lg:p-4">
        ...
        <div className="grid min-h-0 flex-1 grid-cols-1 gap-3 lg:grid-cols-[300px_minmax(0,1fr)_360px] lg:gap-4">
          <motion.div
            {...panel(0.18)}
            className="relative flex min-h-0 items-center justify-center overflow-hidden rounded-xl border border-zinc-200/80 bg-white lg:order-2"
          >
            ...
            <div className="absolute right-3 top-3 z-10 hidden items-center gap-3 font-mono text-[10px] uppercase tracking-[0.12em] text-zinc-500 sm:flex lg:right-4 lg:top-4">
            ...
            <div className="aspect-square h-auto max-h-[70vh] w-full max-w-full lg:h-full lg:w-auto">
              <SightGlobe
                ref={globeRef}
                markers={markers}
                arcs={arcs}
